...
class ProjectList {
  ...
  static {
    ...
    ProjectList.formCancelButton.addEventListener("click", () =>
      ProjectList.closeProjectAddPanel()
    );
  }
  ...
  static editProjectForm =
    ProjectList.projectEditPanel.querySelector(".edit-panel-actual");
  static editProjectFormTitle =
    ProjectList.editProjectForm.querySelector(".title");
  static editProjectFormHeader =
    ProjectList.editProjectForm.querySelector("h2");
  static editProjectFormDescription =
    ProjectList.editProjectForm.querySelector(".description");
  static editProjectFormPriority =
    ProjectList.editProjectForm.querySelector(".priority");
  static editProjectFormCancelButton =
    ProjectList.editProjectForm.querySelector(".cancel-button");
  static editProjectFormDate =
    ProjectList.editProjectForm.querySelector(".date");
  static {
    ProjectList.editProjectForm.addEventListener("submit", function (event) {
      event.preventDefault();
      ProjectList.editProject(
        ProjectList.projects[ProjectList.lastEditedProject],
        ...
        parseISO(ProjectList.editProjectFormDate.value)
      );
      ProjectList.editProjectFormTitle.value = "";
      ProjectList.editProjectFormDescription.value = "";
      ProjectList.editProjectFormPriority.value = "";
    ...
    ProjectList.editProjectFormCancelButton.addEventListener("click", () =>
      ProjectList.closeProjectEditPanel()
    );
  }
  ...
  static toDoForm =
    ProjectList.toDoAddPanel.querySelector(".edit-panel-actual");
  ...
  static toDoFormCancelButton =
    ProjectList.toDoForm.querySelector(".cancel-button");
  static {
    ProjectList.toDoForm.addEventListener("submit", function (event) {
      event.preventDefault();
      ProjectList.projects[ProjectList.lastActiveProject].addToDo(
        ProjectList.toDoFormTitle.value,
        ProjectList.toDoDescription.value,
        ProjectList.toDoPriority.value,
        ProjectList.toDoDate.value
      );
      ProjectList.toDoFormTitle.value = "";
      ProjectList.toDoDescription.value = "";
      ProjectList.toDoPriority.value = "";
    ...
    ProjectList.toDoFormCancelButton.addEventListener("click", () =>
      ProjectList.closeToDoAddPanel()
    );
  }
  //
  ...
  static toDoEditForm =
    ProjectList.toDoEditPanel.querySelector(".edit-panel-actual");
  static toDoEditFormTitle = ProjectList.toDoEditForm.querySelector(".title");
  static toDoEditDescription =
    ProjectList.toDoEditForm.querySelector(".description");
  ...
  static toDoEditFormCancelButton =
    ProjectList.toDoEditForm.querySelector(".cancel-button");
  static {
    ProjectList.toDoEditForm.addEventListener("submit", function (event) {
      ...
      ProjectList.projects[ProjectList.lastActiveProject].editToDo(
        ProjectList.projects[ProjectList.lastActiveProject].toDos[
          ProjectList.lastEditedToDo
        ],
      ...
      ProjectList.toDoEditHeader.textContent =
        "Edit To-Do: " + this.toDoEditFormTitle;
    });

    ProjectList.toDoEditFormCancelButton.addEventListener("click", () =>
      ProjectList.closeToDoEditPanel()
    );
  }
  //
  ...
  static removeProject(arrayIndex) {
    ...
    ProjectList.projects = ProjectList.projects.filter(
      (project) => ProjectList.projects[arrayIndex] != project
    );
  ...
  static chooseProjectIfNeeded() {
    ...
    if (ProjectList.projects.length == 0) {
      ...
      ProjectList.lastActiveProject >= ProjectList.projects.length ||
      !ProjectList.lastActiveProject
    ) {
  ...
  static clearProjects() {
    if (localStorage) localStorage.removeItem("projects");
  ...
  static renderProjectList() {
    ...
    this.projects.forEach((project, index) => {
      project.renderProject(index);
    });

    const addProjectButton = document.createElement("div");
    addProjectButton.classList.add("add-project-button");
    addProjectButton.addEventListener("click", () =>
      ProjectList.showProjectAddPanel()
    );
  ...
  static showProjectEditPanel(index) {
    ...
    ProjectList.projectEditPanel.querySelector("h1").textContent =
      "Edit Project: ";
    ProjectList.projectEditPanel.querySelector(".title").value =
      referenceProject.title;
    ProjectList.projectEditPanel.querySelector(".description").value =
      referenceProject.description;
    ProjectList.projectEditPanel.querySelector(".priority").value = Number(
      referenceProject.priority
    );
    if (isValid(referenceProject.date)) {
      ProjectList.projectEditPanel.querySelector(".date").value = format(
        referenceProject.date,
        "yyyy-MM-dd"
      );
    }
  }
  ...
  static showToDoEditPanel(indexOfToDo) {
    ...
    let referenceToDo =
      ProjectList.projects[this.lastActiveProject].toDos[indexOfToDo];
    ProjectList.toDoEditHeader.textContent = "Edit To-Do: ";
    ProjectList.toDoEditPanel.querySelector(".title").value =
      referenceToDo.title;
    ProjectList.toDoEditPanel.querySelector(".description").value =
      referenceToDo.description;
    if (isValid(referenceToDo.date)) {
      ProjectList.toDoEditPanel.querySelector(".date").value = format(
        referenceToDo.date,
        "yyyy-MM-dd"
      );
    }
    ProjectList.toDoEditPanel.querySelector(".priority").value = Number(
      referenceToDo.priority
    );
...
class Project {
  ...
  renderProject(index) {
    ...
    if (isValid(this.date)) {
      tempContainer.querySelector(".date").textContent =
        "Due by: " + format(this.date, "M/d/yyyy");
    }
    tempContainer.querySelector(".priority").textContent =
      "Priority: " + this.priority;
    tempContainer.querySelector(".checkbox-gap").checked = this.completion;
    tempContainer
      .querySelector(".checkbox-gap")
      .addEventListener("change", () => this.toggleCompletion());
    tempContainer
    ...
    tempContainer
      ...
      .addEventListener("click", () => this.renderToDoList());
    tempContainer
      .querySelector(".delete-button")
      .addEventListener("click", () =>
        ProjectList.removeProject(this.arrayIndex)
      );
  ...
  clearToDoRenders() {
    toDosNode.innerHTML = "";
    const toDosHeader = document.createElement("h1");
    toDosHeader.textContent =
      "To-Dos - " + ProjectList.projects[ProjectList.lastActiveProject].title;
    toDosNode.appendChild(toDosHeader);
  }
  ...
  renderProjectCompletion() {
    if (
      ...
      this.rootDomNode.querySelector("h2").textContent =
...
class ToDo {
  ...
  renderToDo(index) {
    ...
    tempContainer
      .querySelector(".delete-button")
      .addEventListener("click", () =>
        ProjectList.projects[this.projectIndex].removeToDo(this)
      );
